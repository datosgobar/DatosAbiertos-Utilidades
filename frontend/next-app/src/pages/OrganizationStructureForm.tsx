...
import organizations from "../styles/styles-andino-theme/sass/organization/index.module.scss";
    ...
    return <>
            <form onSubmit={handleSubmit}>
                ...
                <div className={organizations.organization}>
                    <div className={organizations.organizationList}>
                        <div className={organizations.organizationListTitle}>
                            <span>Organizacion</span>
                            <span className={organizations.countTitle}>Datasets totales</span>
                        </div>
                        <div className={organizations.organizationBranch}>
                           <div className={organizations.organizationName +' '+ organizations.topOrganization}>
                            ...
                            <span className={organizations.organizationCount}>84</span>
                            <div className={organizations.organizationBranch}>
                                <div className={organizations.organizationName}>
